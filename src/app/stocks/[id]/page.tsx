...
import { CompanyDetailsComponent, CompanyDetailsComponentFromID } from "@/components/CompanyDetails";
...
export default async function Page({ params }: { params: { id: string } }) {
     ...
     return (<>
          {(stock && company) ? (<main style={{ backgroundColor: 'black', color: 'black', fontSize: '2rem', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }}>
