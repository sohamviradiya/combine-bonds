...
export const BOT_LOSS_AVERSION = 0.2;
export const BOT_STOCK_CLEARANCE = 0.3;
...
export const hostname = process.env.NODE_ENV === 'production' ? 'https://combine-bonds.vercel.app' : 'http://localhost:3000';
