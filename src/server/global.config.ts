...
export const AGENCY_PRICE_INCREMENT = 0.04;

export const BOT_MIN_INVESTMENT = 0.01;
export const BOT_INVESTMENT_MULTIPLIER = 2;
export const BOT_LOSS_AVERSION = 0.1;
export const BOT_STOCK_CLEARANCE = 0.4;
...
export const DEFAULT_MARKET_SENTIENCE_INDEX = 1000;
